...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* prox features */
        {"prox", "masternode", &masternode, true, true, false},
        {"prox", "listmasternodes", &listmasternodes, true, true, false},
        {"prox", "getmasternodecount", &getmasternodecount, true, true, false},
        {"prox", "masternodeconnect", &masternodeconnect, true, true, false},
        {"prox", "masternodecurrent", &masternodecurrent, true, true, false},
        {"prox", "masternodedebug", &masternodedebug, true, true, false},
        {"prox", "startmasternode", &startmasternode, true, true, false},
        {"prox", "createmasternodekey", &createmasternodekey, true, true, false},
        {"prox", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"prox", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"prox", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"prox", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"prox", "getmasternodescores", &getmasternodescores, true, true, false},
        {"prox", "mnbudget", &mnbudget, true, true, false},
        {"prox", "preparebudget", &preparebudget, true, true, false},
        {"prox", "submitbudget", &submitbudget, true, true, false},
        {"prox", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"prox", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"prox", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"prox", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"prox", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"prox", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"prox", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"prox", "checkbudgets", &checkbudgets, true, true, false},
        {"prox", "mnsync", &mnsync, true, true, false},
        {"prox", "spork", &spork, true, true, false},
        {"prox", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"prox", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use proxd, or the -server option to prox-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> prox-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23499/\n";
}
