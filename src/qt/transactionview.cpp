                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received prox from zprox"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zprox"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zprox));
