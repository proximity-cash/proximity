...
/** Utility functions used by the prox Qt UI.
 */
namespace GUIUtil
{
...
// Render prox addresses in moproxpace font
...
// Parse "prox:" URI into recipient object, return true on successful parsing
