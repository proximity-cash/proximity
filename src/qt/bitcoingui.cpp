                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Proximity Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a prox address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and prox: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPROX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Proximity Core"), this);
    aboutAction->setStatusTip(tr("Show information about Proximity Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for prox"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your prox addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified prox addresses"));
    ...
    openAction->setStatusTip(tr("Open a prox: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Proximity Core help message to get a list with possible prox command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Proximity Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to prox network", "", count));
}
...
{
    QString strTitle = tr("Proximity Core"); // default title
...
/** Creates context menu, its actions, and proxs up all the relevant signals for mouse events. */
