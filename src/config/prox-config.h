/* src/config/prox-config.h.  Generated from prox-config.h.in by configure.  */
/* src/config/prox-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.prox.cash"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Proximity Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Proximity Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "prox"
