...
This means one can have an always-on proxd instance running, and another local proxd/prox-qt instance which connects to this node and receives blocks from it.
