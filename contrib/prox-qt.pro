...
RESOURCES += src/qt/prox.qrc src/qt/prox_locale.qrc

TRANSLATIONS += src/qt/locale/prox_bg.ts \
                src/qt/locale/prox_de.ts \
                src/qt/locale/prox_en.ts \
                src/qt/locale/prox_es.ts \
                src/qt/locale/prox_fi.ts \
                src/qt/locale/prox_fr.ts \
                src/qt/locale/prox_it.ts \
                src/qt/locale/prox_ja.ts \
                src/qt/locale/prox_pl.ts \
                src/qt/locale/prox_pt.ts \
                src/qt/locale/prox_ru.ts \
                src/qt/locale/prox_sk.ts \
                src/qt/locale/prox_sv.ts \
                src/qt/locale/prox_vi.ts \
                src/qt/locale/prox_zh_CN.ts \
                src/qt/locale/prox_zh_TW.ts
