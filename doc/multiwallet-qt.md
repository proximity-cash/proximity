...
In order to support loading of multiple wallets in prox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is prox.cpp.
...
Changes to prox.cpp
----------------------
prox.cpp is the entry point into prox-qt, and as such, will require some minor modifications to provide hooks for
