Contributing to Proximity Core
============================

The Proximity Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Proximity Core project, and is not to be
confused with overall prox Network Protocol consensus changes.

Whether a pull request is merged into Proximity Core rests with the project merge
...
Patches that change prox consensus rules are considerably more involved than
...
Where a patch set proposes to change the prox consensus, it must have been
...
The project leader is the release manager for each Proximity Core release.
